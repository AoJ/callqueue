...
var start = function (libPath, methods) {
	return workerFarm({
		maxCallsPerWorker: -1, maxConcurrentWorkers: 1, maxConcurrentCallsPerWorker: 1, maxConcurrentCalls: -1, maxCallTime: 0
	}, libPath, methods);
};
...
var app = function (libPath, methods, options) {
	...
	this.workers = start(this.libPath, this.methods);
	this.run = {};
...
module.exports = exports = function (libPath, methods) {
	return new app(libPath, methods);
};